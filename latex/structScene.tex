...
\begin{DoxyCompactList}\item\em Конструктор, що створює об\textquotesingle{}єкти у сцені за заготовленими у агрументі {\ttfamily objects} \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\item\em Створює сцену \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\item\em Об\textquotesingle{}єкти у сцені. \end{DoxyCompactList}\end{DoxyCompactItemize}
