...
Діаграма включених заголовочних файлів можна переглянути на рис.~\ref{fig:beziator_8h__incl},
а граф файлів, які включають файл на рис.~\ref{fig:beziator_8h__dep__incl}
...
\caption{Діаграма включених заголовочних файлів для beziator.\+h\+}\label{fig:beziator_8h__incl}
\end{center}
\end{figure}
\begin{figure}[H]
\begin{center}
...
\caption{Граф файлів, які включають файл beziator.\+h\+}\label{fig:beziator_8h__dep__incl}
\end{center}
\end{figure}
...
\begin{DoxyCompactList}\item\em Клас який зберігає та оброблює модель утворену через поверхні Безьє. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\item\em Набір індексів на вершини, що утворюють поверхню 4x4. \end{DoxyCompactList}\end{DoxyCompactItemize}
